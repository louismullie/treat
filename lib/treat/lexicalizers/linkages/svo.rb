# A class that retrieves information about
# subjects, verbs and objects within sentences.
class Treat::Lexicalizers::Linkages::SVO

  # Find the subject(s), verb(s) and object(s)
  # in a sentence and link them to the sentence.
  #
  # Options: 
  # 
  # - (Symbol) :linkage => :subject|:verb|:object,
  #   the linkage to retrieve within the sentence.
